...
* **Pointer pool – `VA 0x0037E820 (file+0x0017E820)`**  
  The addresses above are collated into a literal table starting at this VA. The helper at `VA 0x00217DD0 (file+0x00017DD0)` iterates this pool and pushes candidate pointers into the worker routines.
